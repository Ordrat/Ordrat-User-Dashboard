...
const badgeVariants = cva(
  'inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        lg: 'rounded-[0.375rem] px-[0.5rem] h-7 min-w-7 gap-1.5 text-xs [&_svg]:size-3.5',
        md: 'rounded-[0.3125rem] px-[0.45rem] h-6 min-w-6 gap-1 text-xs leading-[0.75rem] [&_svg]:size-3',
        sm: 'rounded-[0.25rem] px-[0.375rem] h-5 min-w-5 gap-1 text-[0.6875rem] leading-[0.75rem] [&_svg]:size-3',
        xs: 'rounded-[0.25rem] px-[0.25rem] h-4 min-w-4 gap-0.5 text-[0.625rem] leading-[0.5rem] [&_svg]:size-2.5',
      },
      shape: {
        default: '',
        circle: 'rounded-full',
...
const badgeButtonVariants = cva(
  'cursor-pointer transition-all inline-flex items-center justify-center leading-none size-3.5 [&>svg]:opacity-100! [&>svg]:size-3.5! p-0 rounded-[0.3rem] -me-0.5 opacity-60 hover:opacity-100',
  {
    variants: {
      variant: {
        default: '',
